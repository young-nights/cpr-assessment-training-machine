...
| Conscious Judgment | Consciousness judgment indicator | PF1 | `LED_CONSCIOUS_JUDGMENT_Pin` |
| Sphygmoscopy | Pulse check indicator | PF0 | `LED_SPHYGMOSCOPY_Pin` |
| Check Breath | Breath check indicator | PC15 | `LED_CHECK_BREATH_Pin` |
| Emergency Call | Emergency call indicator | PC14 | `LED_EMERGENCY_CALL_Pin` |
| Remove Foreign | Remove foreign object indicator | PC13 | `LED_REMOVE_FOREIGN_Pin` |
...
| Competition | Competition mode indicator | PG7 | `LED_COMPETITION_Pin` |
| Assess | Assessment mode indicator | PE9 | `LED_ASSESS_Pin` |
| Train | Training mode indicator | PG8 | `LED_TRAIN_Pin` |
| Minus | Minus indicator | PE12 | `LED_MINUS_Pin` |
| Plus | Plus indicator | PG5 | `LED_PLUS_Pin` |
| Setting | Settings indicator | PD13 | `LED_SETTING_Pin` |
