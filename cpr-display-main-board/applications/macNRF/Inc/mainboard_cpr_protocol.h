 ...
 */
#ifndef APPLICATIONS_MACNRF_INC_MAINBOARD_CPR_PROTOCOL_H_
#define APPLICATIONS_MACNRF_INC_MAINBOARD_CPR_PROTOCOL_H_
...
#endif /* APPLICATIONS_MACNRF_INC_MAINBOARD_CPR_PROTOCOL_H_ */
